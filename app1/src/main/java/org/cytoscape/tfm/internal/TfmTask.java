...
public class TfmTask extends AbstractTask {
	...
	public void run(TaskMonitor taskMonitor) {
		...
		group.add(rbMenuItem);
		submenuAlgoritmos.add(rbMenuItem);
		rbMenuItem = new JRadioButtonMenuItem("Kendall");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (status == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						try {
							FileWriter myObj = new FileWriter("C:\\Users\\joska.DESKTOP-E3RKVON\\Desktop\\Pruebas\\Salidas\\pasanFiltro.txt");
							myObj.flush();
	...
	public void grafo(List<ArrayList<String>> pasanFiltro, List<ArrayList<String>> salidas){
		...
		JOptionPane.showMessageDialog(null, "Grafo 5/5", "InfoBox: " + "Grafo", JOptionPane.INFORMATION_MESSAGE);
		//---Termina NUEVO
		/*for(ArrayList<String> parejas:pasanFiltro){
			//nds=myNet.getNodeList();
			String origen = parejas.get(0);
